    ...
    <section className="bg-[#f8f9fa] py-16 sm:py-20 lg:py-28">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-[#f27f32]  drop-shadow-md mb-4">
            {state.subHeader}
          </h1>
        ...
        <div className=" bg-white px-6 py-8 sm:px-10 sm:py-10 rounded-xl shadow-md border border-gray-200 transition-all duration-300">
          ...
          <p className="text-gray-600 text-base sm:text-lg leading-relaxed">
            Geo Matrix Solutions is driven by the mission to provide top-tier
            surveying and engineering services. Our team of experts strives to
            implement cutting-edge technologies to deliver exceptional results
            and ensure the highest level of precision in every project we
            undertake. We are committed to improving the infrastructure and
            environmental sustainability of the regions we serve.
          </p>
        </div>
      </div>
    </section>
